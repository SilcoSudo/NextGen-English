...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      {activeTab === "dashboard" ? (
        <StudentDashboard onBackHome={() => setActiveTab("home")} />
      ) : activeTab === "courses" ? (
        <ExploreCourses />
      ) : (
        <>
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-12">
                Tại sao chọn{" "}
                <span className="text-blue-500">NextGen English</span>?
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <div className="flex space-x-4">
                    {/* Social links - dùng button thay vì a href="#" để sạch cảnh báo */}
                    <button
                      type="button"
