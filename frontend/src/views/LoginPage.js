                ...
                <div className="w-full flex justify-center">
                  <button
                    ...
                    onClick={() => {
                      ...
                      // Backend will handle redirecting to Google and back
                    ...
                    className="w-full bg-white border border-gray-300 rounded-xl py-4 px-6 font-semibold text-gray-700 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center gap-3 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-gray-200"
                  >
