      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto">
            Truy cập và xem lại các video học tiếng Anh mà bạn đã mua. Học mọi lúc, mọi nơi!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-white/60 backdrop-blur-lg rounded-2xl p-4 sm:p-6 text-center border border-white/20">
            ...
            <div className="text-gray-600 font-medium text-xs sm:text-sm">Video đã mua</div>
          </div>
          <div className="bg-white/60 backdrop-blur-lg rounded-2xl p-4 sm:p-6 text-center border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Tìm kiếm video đã mua..."
                  value={searchQuery}
          ...
          <div className="text-center py-12">
            {purchasedVideos.length === 0 ? (
              <>
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Chưa có video nào</h3>
                <p className="text-gray-600 mb-6">Bạn chưa mua video nào. Hãy khám phá thư viện video phong phú của chúng tôi!</p>
                <a
                  href="#/videos"
              ...
              <>
                <div className="text-6xl mb-4">🔍</div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">Không tìm thấy video</h3>
                <p className="text-gray-600 mb-6">Không có video nào phù hợp với bộ lọc của bạn</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
          ...
          <div className="mt-12 bg-white/60 backdrop-blur-lg rounded-2xl p-4 sm:p-6 border border-white/20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="bg-blue-50 rounded-xl p-4">
                ...
                <div className="text-xs text-gray-600">Video Nghe</div>
              </div>
              <div className="bg-green-50 rounded-xl p-4">
                <div className="text-2xl font-bold text-green-600 mb-1">
                  {purchasedVideos.filter(v => v.skill === 'Nói').length}
                </div>
                <div className="text-xs text-gray-600">Video Nói</div>
              </div>
              <div className="bg-purple-50 rounded-xl p-4">
                <div className="text-2xl font-bold text-purple-600 mb-1">
                  {purchasedVideos.filter(v => v.skill === 'Đọc').length}
                </div>
                <div className="text-xs text-gray-600">Video Đọc</div>
              </div>
              <div className="bg-orange-50 rounded-xl p-4">
                <div className="text-2xl font-bold text-orange-600 mb-1">
                  {purchasedVideos.filter(v => v.skill === 'Viết').length}
                </div>
                <div className="text-xs text-gray-600">Video Viết</div>
              </div>
            </div>
          </div>
        )}
